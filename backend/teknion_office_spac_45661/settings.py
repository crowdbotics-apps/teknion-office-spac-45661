"""
Django settings for teknion_office_spac_45661 project.
...
ROOT_URLCONF = 'teknion_office_spac_45661.urls'
...
WSGI_APPLICATION = 'teknion_office_spac_45661.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "teknion_office_spac_45661 API",
    "DESCRIPTION": "API documentation for teknion_office_spac_45661 App",
    "VERSION": "v1",
}
